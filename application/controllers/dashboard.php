...
class Dashboard extends MY_Controller
{
    ...
    public function index()
    {
        try {
            ...
            $this->view_data['typesDocuments'] = Parameter::find('all', array('conditions' => array('parameter_class = ? AND parameter_status = ? AND store_id = ?', 1000, 1 , $this->store)));
            $this->view_data['typesPayments'] = Parameter::find('all', array('conditions' => array('parameter_class = ? AND parameter_status = ? AND store_id = ?', 1001, 1 , $this->store)));
