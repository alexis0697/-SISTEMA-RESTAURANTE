<!-- Page Content -->
<div class="container view_products">
   <div class="page-header pr-0">
      <button type="button" class="btn btn-primary btn-pill btn-lg" data-toggle="modal" data-target="#Addproduct"><i class="fa fa-plus-circle"></i> <?= label("AddProduct"); ?></button>
      <div class="float-right">
         <a href="products/generateXlsProducts">
            <button type="button" class="btn btn-success btn-sm mt-2 mr-2 dropdown-toggle"><i class="fa fa-download"></i> Exportar Excel
            </button>
         </a>
         <button type="button" data-toggle="modal" data-target="#ImportProducts" class="btn btn-info btn-sm mt-2 mr-2 dropdown-toggle"><i class="fa fa-upload"></i> <?= label("UploadCSVfile"); ?>
         </button>
         <button type="button" data-toggle="modal" data-target="#PrintMenu" class="btn btn-danger btn-sm mt-2 mr-2 dropdown-toggle"><i class="fa fa-cutlery"></i> <?= label("Imprimir Menú"); ?>
         </button>
      </div>
   </div>
   <p class="text-danger" style="color: red;font-weight: bold;text-align: center;">
      <?php
   ...
   <div class="card">
      ...
      <div class="card-body">
         <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12" style="z-index: 1">
               <form action="products" method="post" class="form-inline float-right hidden-xs hidden-sm" style="margin-bottom:-50px;">
                  <label for="SupplierFilter"><?= label("Supplier"); ?></label>
                  <select class="form-control" id="SupplierFilter" name="filtersupp">
                     ...
                     <tbody>
                        <?php foreach ($products as $product) : ?>
                           <tr>
                              ...
                              <!-- <td><?= $product->tax; ?></td> -->
                              <td data-order="<?= $product->price; ?>"><?= $this->setting->currency; ?> <?= number_format((float)$product->price, $this->setting->decimals, '.', ''); ?></td>
                              <td>
                                 <div class="btn-group">
                                    <a class="btn btn-success" href="javascript:void(0)" onclick="Viewproduct(<?= $product->id; ?>)"><i class="fa fa-file-text" data-toggle="tooltip" data-placement="top" title="<?= label('Viewproduct'); ?>"></i></a>
                                    <a class="btn btn-info" href="products/edit/<?= $product->id; ?>" data-toggle="tooltip" data-placement="top" title="<?= label('Edit'); ?>"><i class="fa fa-pencil"></i></a>
                                    <?php if ($this->user->role === "admin") { ?><a class="btn btn-danger" href="javascript:void(0)" data-toggle="popover" data-placement="left" title="<?= label('Delete'); ?>" data-html="true" title='<?= label("Areyousure"); ?>' data-content='<a class="btn btn-danger" href="products/delete/<?= $product->id; ?>"><?= label("yesiam"); ?></a>'><i class="fa fa-times"></i></a><?php } ?>
                                    <?php if ($this->user->role === "admin" && $product->type === 0) { ?><a class="btn btn-warning" href="javascript:void(0)" onclick="modifystock(<?= $product->id; ?>)"><i class="fa fa-tasks" data-toggle="tooltip" data-placement="top" title='<?= label("ModifyStock"); ?>'></i></a><?php } ?>
                                    ...
                                    <a class="btn btn-default" href="javascript:void(0)" data-toggle="modal" data-target="#barcode" onclick="productBcode = <?= $product->id; ?>"><i class="fa fa-barcode" data-toggle="tooltip" data-placement="top" title="<?= label('printBarcodes'); ?>"></i></a>
                                 </div>
                              </td>
                           </tr>
                        <?php endforeach; ?>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="form-group controls">
                     ...
                     <input type="text" readonly="readonly" maxlength="30" Required name="code" class="form-control" id="ProductCode" placeholder="<?= label("ProductCode"); ?>">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="name" maxlength="200" Required class="form-control" id="ProductName" placeholder="<?= label("ProductName"); ?>">
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <label for="Price"><?= label("PriceProduct"); ?> (<?= $this->setting->currency; ?>)</label>
            ...
            <!-- <div class="row">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" maxlength="10" name="tax" value="<?= $this->setting->tax; ?>" readonly class="form-control" id="Tax" placeholder="<?= label("ProductTax"); ?>">
                  </div>
               </div>
            </div> -->
               ...
               <div class="col-md-4">
                  <div class="form-group" id="UnitP">
                     ...
                     <select class="form-control" name="unit" id="Unit">
                        ...
                        <?php foreach ($units_measurements as $unit) : ?>
            ...
            <div class="row">
               <div class="col-md-6">
                  <label for="exampleInputFile"><?= label("Imageinput"); ?> <span style="color:red;font-size: .9em;font-weight: 600;">* Tamaño máximo de imagen: 1000 x 1000</span></label>
...
<div class="modal fade" id="barcode" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   <div class="modal-dialog" role="document" id="stockModal">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="barcode"><?= label("Generar Códigos de Barras"); ?></h4>
         </div>
         <div class="modal-body" id="modal-body">
