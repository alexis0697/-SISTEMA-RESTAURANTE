...
<div class="container">
   ...
   <?php echo form_open_multipart('products/edit/' . $product->id); ?>
      ...
      <div class="row">
         ...
         <div class="col-md-4">
            <div class="form-group">
               ...
               <input type="text" name="code" disabled maxlength="200" Required value="<?= $product->code; ?>" class="form-control" id="ProductCode" placeholder="<?= label("ProductCode"); ?>">
      ...
      <div class="row">
         <div class="col-md-4">
            <div class="form-group">
               ...
               <input type="text" name="tax" maxlength="10" disabled value="<?= $product->tax; ?>" class="form-control" id="Tax" placeholder="<?= label("ProductTax"); ?>">
            </div>
         </div>
         <div class="col-md-4">
            <div class="form-group">
               <label for="taxType"><?= label("TaxMethod"); ?></label>
               <select class="form-control" name="taxmethod" id="taxType" disabled>
            ...
            <div class="form-group" id="UnitP">
               ...
               <select class="form-control" name="unit" id="Unit">
                  ...
                  <?php foreach ($units_measurements as $unit) : ?>
                     <option <?= $product->unit === $unit->id ? 'selected' : ''; ?> value="<?= $unit->id; ?>"><?= $unit->name; ?></option>
                  <?php endforeach; ?>
               </select>
            </div>
         </div>
      ...
      <div class="row">
         ...
         <div class="col-md-4">
            <?php if ($product->photo) { ?><img src="<?= base_url() ?>files/products/<?= $product->photo; ?>" alt="" width="150px" /><?php } ?>
         </div>
         <div class="col-md-4">
            <div class="form-group">
               <div class="btn-group white" data-toggle="buttons">
                  ...
                  <label class="btn color01">
                     <input type="radio" name="color" id="option1" value="color01" autocomplete="off" <?php if ($product->color == 'color01') {
                                                                                                         echo 'checked';
                                                                                                      } ?>> C1
                  </label>
                  <label class="btn color02">
                     <input type="radio" name="color" id="option2" value="color02" autocomplete="off" <?php if ($product->color == 'color02') {
                                                                                                         echo 'checked';
                                                                                                      } ?>> C2
                  </label>
                  <label class="btn color03">
                     <input type="radio" name="color" id="option3" value="color03" autocomplete="off" <?php if ($product->color == 'color03') {
                                                                                                         echo 'checked';
                                                                                                      } ?>> C3
                  </label>
                  <label class="btn color04">
                     <input type="radio" name="color" id="option4" value="color04" autocomplete="off" <?php if ($product->color == 'color04') {
                                                                                                         echo 'checked';
                                                                                                      } ?>> C4
                  </label>
                  <label class="btn color05">
                     <input type="radio" name="color" id="option5" value="color05" autocomplete="off" <?php if ($product->color == 'color05') {
                                                                                                         echo 'checked';
                                                                                                      } ?>> C5
                  </label>
                  <label class="btn color06">
                     <input type="radio" name="color" id="option6" value="color06" autocomplete="off" <?php if ($product->color == 'color06') {
                                                                                                         echo 'checked';
                                                                                                      } ?>> C6
                  </label>
                  <label class="btn color07">
                     <input type="radio" name="color" id="option7" value="color07" autocomplete="off" <?php if ($product->color == 'color07') {
                                                                                                         echo 'checked';
                                                                                                      } ?>> C7
                  </label>
                  <label class="btn color08">
                     <input type="radio" name="color" id="option8" value="color08" autocomplete="off" <?php if ($product->color == 'color08') {
                                                                                                         echo 'checked';
                                                                                                      } ?>> C7
                  </label>
               </div>
