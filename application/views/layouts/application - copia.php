   ...
   <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="min-height: 70px;">
      <div class="container-fluid">
         <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><?php if ($this->setting->logo) { ?><img src="<?= base_url() ?>files/Setting/<?= $this->setting->logo; ?>" alt="logo" style='max-height: 60px;max-width: 60px;margin-top: -11px;'><?php } else { ?><img src="<?= base_url() ?>assets/img/logo.png" alt="logo"><?php } ?></a>
         </div>
                  ...
                  <?php if ($this->user->role !== "waiter" && $this->user->role !== "kitchen") { ?>
                     ...
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           <li class="flat-box"><a href="<?= base_url() ?>categories"><i class="fa fa-archive"></i> <span class="menu-text"><?= label("CategoryProduct"); ?></span></a></li>
                           <li class="flat-box"><a href="<?= base_url() ?>categorie_expences"><i class="fa fa-usd"></i> <span class="menu-text"><?= label("CategoryExpense"); ?></span></a></li>
                           <li class="flat-box"><a href="<?= base_url() ?>unit_measurements"><i class="fa fa-balance-scale"></i> <span class="menu-text"><?= label("Unidades de Medida"); ?></span></a></li>
                        </ul>
                     </li>
