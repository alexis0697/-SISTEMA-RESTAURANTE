...
<div class="container">
   <div class="page-header pr-0">
      <button type="button" class="btn btn-primary btn-pill btn-lg" data-toggle="modal" data-target="#Addcategory">
         <i class="fa fa-plus-circle"></i> <?= label("AddCategory"); ?>
      </button>
   </div>
   <div class="card">
      <div class="card-header bg-info">
         <h3 class="my-0">Listado de Categorías de Gastos</h3>
      </div>
      <div class="card-body">
         <div class="row">
            <div class="col-md-12">
